...
<div class="admin-panel-container">
    ...
    <div class="panel-actions"><a href="criar_conta_painel.php" class="btn-panel-primary">Criar Nova Conta</a><a href='index.php' class="btn-panel-secondary">Voltar à Home</a></div>
    <div class="table-responsive-panel">
        <table class="product-data-table">
            <thead><tr><th>ID</th><th>Nome</th><th>Nível</th><th>Ações</th></tr></thead>
            <tbody>
            <?php
